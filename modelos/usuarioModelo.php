<?php
    // Formas Incorrectas de acceder al archivo

        // require_once "./mainModel.php"; //Asi aparece en el video pero a nosotros no nos deja acceder asi
        //  require_once SERVERURL.'modelos/mainModel.php'; //Aunque la ruta es practicamente correcta (http://localhost/Prestamos/) Es servidor no deja acceder a los archivos desde http por temas de seguridad
        
    // Formas correctas de acceder al archivo
        // require_once "../modelos/mainModel.php"; 
        require_once SERVERPATH.'modelos/mainModel.php';
        // require_once "D:/Instalados/Xampp/htdocs/Prestamos/modelos/mainModel.php";
    ...
    class usuarioModelo extends mainModel{
        ...
        /*---------- Modelo seleccionar datos del usuario ----------*/
