...
class mainModel{
/*-------- FUNCION PAR CONECTAR A LA BD --------- */
    protected static function conectar(){
        try {
            $conexion = new PDO(SGBD, USER, PASS); // valores obtenidos de SERVER.php
...
/*-------- FUNCION PAR EJECUTAR CONSULTAS SIMPLES A LA BD --------- */
...
/*-------- Funcion para verificar datos --------- */
    protected static function verificar_datos($filtro, $cadena){
        if(preg_match("/^".$filtro."$/",$cadena)){
            return false; // no tiene errores la cadena
        }else{
            return true; // tiene errores la cadena
        }
    }
...
/*-------- Funcion para verificar fechas --------- */
    protected static function verificar_fecha($fecha){
       ...
       if(count($valores) == 3 && checkdate($valores[1], $valores[2], $valores[0])){
        return false; // no tiene errores la fecha
       }else{
        return true; // tiene errores la fecha
       } 
    }
...
/*-------- Funcion de paginador de tablas --------- */ 
    protected static function paginador_tablas($pagina, $Npaginas, $url, $botones){
        ...
        if($pagina == 1){
            ...
            <li class="page-item"><a class="page-link" href="'.$url.($pagina-1).'/"><<</a></li>
            ';
        }
        ...
        if($pagina == $Npaginas){
            ...
            $tabla .= '<li class="page-item"><a class="page-link" href="'.$url.($pagina+1).'/">>></a></li>
