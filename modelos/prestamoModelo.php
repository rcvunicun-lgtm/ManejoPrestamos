...
/*---------- Modelo agregar prestamo ----------*/
    ...
    protected static function agregar_detalle_modelo($datos){
        ...
        $sql->bindParam(':Costo', $datos['CostoTiempo']);
    ...
    protected static function agregar_pago_modelo($datos){
        ...
        return $sql;
    }  /* Fin modelo agregar pago */


    /*---------- Modelo eliminar prestamo ----------*/
    protected static function eliminar_prestamo_modelo($codigo_prestamo, $tipo){
        if($tipo == "Prestamo"){
        ...
        $sql->bindParam(':Codigo', $codigo_prestamo);
    ...
    /*---------- Modelo seleccionar datos prestamo ----------*/
    protected static function datos_prestamo_modelo($tipo, $id){
        ...
        return $sql;
    }/* Fin modelo seleccionar datos prestamo */
