<?php
    if($_SESSION['privilegio_spm'] < 1 || $_SESSION['privilegio_spm'] > 2){ 
        echo($login_controller->forzar_cierre_sesion_controlador());
        exit(); 
    }
?>
<!-- Page header -->
    ...
    <div class="container-fluid form-neon">
        ...
        <div class="container-fluid">
            <?php
                    ...
                    $datos_cliente= $ins_cliente->datos_cliente_controlador("Unico", $login_controller->encryption($campos['cliente_id']));
            ...
            <div class="table-responsive">
                <table class="table table-dark table-sm">
                    ...
                    <tbody>
                        <?php
                            $datos_detalle = $ins_prestamo->datos_prestamo_controlador("Detalle", $login_controller->encryption($campos['prestamo_codigo']));
        ...
        <form class="FormularioAjax" action="<?php echo(SERVERURL)?>ajax/prestamoAjax.php" method="post" data-form="save" autocomplete="off">
            <input type="hidden" name="prestamo_codigo_up" value="<?php echo($login_controller->encryption($campos['prestamo_codigo']));?>">
            <fieldset>
                ...
                <div class="modal-body">
                    <div class="table-responsive" >
                        <table class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                <?php 
                                    $datos_pagos = $ins_prestamo->datos_prestamo_controlador("Pago",$login_controller->encryption($campos['prestamo_codigo']));
                    ...
                    <div class="container-fluid">
                        <input type="hidden" name="pago_codigo_reg" value="<?php echo($login_controller->encryption($campos['prestamo_codigo']));?>">
                        <div class="form-group">
