                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" pattern="[0-9 \.]{1,10}" class="form-control" readonly="" value="<?php echo(MONEDA . number_format($_SESSION['prestamo_total'], 2, '.' , ''));?>" id="prestamo_total" maxlength="10">
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid" id="tabla_clientes">
                    <!-- Codigo incrustrado desde reservation.php -->
                </div>
