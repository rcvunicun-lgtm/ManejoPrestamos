<?php
    ...
    if($login_controller->encryption($_SESSION['id_spm']) != $pagina[1]){
        if($_SESSION['privilegio_spm'] != 1){ 
            echo($login_controller->forzar_cierre_sesion_controlador());
            exit();
        }
...
<div class="container-fluid">
  ...
  <?php
    ...
    <!-- Este formulario esta siendo enviado desde el archivo alertas.js -->
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <span>Estado de la cuenta  &nbsp; 
                                ...
                                } else if($campos['usuario_estado'] == "Deshabilitada"){
                                    echo('<span class="badge-danger">Deshabilitada</span>');
                                }
                                ?>
                            </span>
