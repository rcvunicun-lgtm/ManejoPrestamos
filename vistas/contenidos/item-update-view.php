                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="item_estado_up" id="item_estado">
                                ...
                                <?php
                                if($campos['item_estado'] == 'Habilitado'){
                                ?>
                                <option value="Habilitado" selected>Habilitado <?php if($campos['item_estado'] == 'Habilitado'){echo("(Actual)");} ?></option>
                                <option value="Deshabilitado">Deshabilitado</option>
                                <?php
                                 }else{
                                ?>
                                <option value="Habilitado">Habilitado</option>
                                <option value="Deshabilitado" selected>Deshabilitado <?php if($campos['item_estado'] == 'Deshabilitado'){echo("(Actual)");} ?></option>
                                <?php        
                                    }
                                ?>
                            </select>
