...
<div class="container-fluid">
    <!-- Este formulario esta siendo ejecutado desde el archivo alertas.js -->
...
<?php
        ...
        echo($ins_usuario->paginador_usuario_controlador($pagina[1], 2, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], $_SESSION['busqueda_usuario']));
   ?>
</div>
